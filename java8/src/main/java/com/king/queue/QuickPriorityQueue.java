...
public class QuickPriorityQueue <T extends QueueItem> {
		private T[] heap;
		...
		public  QuickPriorityQueue(int capacity) {
			super();
			
			heap= (T[])Array.newInstance(QueueItem.class,capacity);
			//minHeap.buildHeap(heap);
			this.heapLength = capacity;
		}
